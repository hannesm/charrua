...
module Lease : sig
  ...
  val add_reservations : database -> (Macaddr.t -> string) ->
    (Ipaddr.V4.t * int32 * string) list -> database
  ...
  val addr_allocated : Ipaddr.V4.t -> database -> now:int32 -> bool
  val addr_available : Ipaddr.V4.t -> Macaddr.t -> database -> now:int32 -> bool
  val get_usable_addr :
    Macaddr.t -> Dhcp_wire.client_id -> database ->
